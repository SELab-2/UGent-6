...
import { Button, Card, Input, Segmented, Switch, Typography, Upload } from "antd"
      ...
      <div style={{ maxWidth: "80%", margin: "0 auto" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <div>
            ...
            >
              {t("project.tests.title", { projectName: project?.name })}
            </Title>
        ...
        <div style={{ marginTop: "20px" }}>
          ...
          <Switch
            checked={enableFeatureTests}
            onChange={handleFeatureTestsChange}
          />
        </div>
        ...
        <div style={{ marginTop: "20px" }}>
          ...
          <Switch
            checked={enableDockerTests}
            onChange={handleDockerTestsChange}
          />
        </div>
        ...
        {enableDockerTests && (
          <>
            ...
            <div style={{ marginTop: "20px" }}>
              ...
              <CodeBlock
                value={dockerScriptText}
                placeholder={t("project.tests.dockerScriptPlaceholder")}
        ...
        <div>
          ...
          <Segmented
            ...
            options={[
              {
                value: "Template",
                label: t("project.tests.modeTemplate"),
              },
              {
                value: "Simpel",
                label: t("project.tests.modeSimple"),
              },
            ]}
            value={mode}
        ...
        {mode === "Template" && (
          <>
            ...
            <CodeBlock
              value={templateText}
              placeholder={t("project.tests.modeTemplatePlaceholder")}
